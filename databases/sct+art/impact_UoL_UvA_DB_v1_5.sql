...
-- Dumping database structure for impact_UoL_UvA_DB_v1_5
DROP DATABASE IF EXISTS `impact_UoL_UvA_DB_v1_5`;
CREATE DATABASE IF NOT EXISTS `impact_UoL_UvA_DB_v1_5` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `impact_UoL_UvA_DB_v1_5`;


-- Dumping structure for table impact_UoL_UvA_DB_v1_5.action
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='Actions that can be executed.';

-- Dumping data for table impact_UoL_UvA_DB_v1_5.action: ~4 rows (approximately)
DELETE FROM `action`;
...
INSERT INTO `action` (`action_id`, `action_name`, `agent`, `datetime`, `user`, `relation_id`, `mutation_sort`, `tsc_id`) VALUES
	...
	(3, NULL, 3, '2012-12-17 10:19:25', NULL, NULL, 'create', 5),
	(4, NULL, 4, '2013-01-18 19:18:23', NULL, NULL, 'create', 18);
/*!40000 ALTER TABLE `action` ENABLE KEYS */;


-- Dumping structure for table impact_UoL_UvA_DB_v1_5.agent
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.agent: ~4 rows (approximately)
DELETE FROM `agent`;
...
INSERT INTO `agent` (`agent_id`, `agent_name`, `datetime`, `user`, `relation_id`, `mutation_sort`, `tsc_id`) VALUES
	...
	(3, 'government', '2012-12-17 10:19:25', NULL, NULL, 'create', 4),
	(4, 'the government', '2013-01-18 19:18:22', NULL, NULL, 'create', 17);
/*!40000 ALTER TABLE `agent` ENABLE KEYS */;


-- Dumping structure for table impact_UoL_UvA_DB_v1_5.ART_discussions
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.ART_discussions: ~26 rows (approximately)
DELETE FROM `ART_discussions`;
...
-- Dumping structure for table impact_UoL_UvA_DB_v1_5.ART_documents
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.ART_documents: ~4 rows (approximately)
...
INSERT INTO `ART_documents` (`id`, `first_id`, `version`, `title`, `text`, `url`, `timestamp_added`, `added_by`, `timestamp_removed`, `removed_by`) VALUES
	...
	(8, 8, 1, 'LIBER reply to the green paper', 'Question 9. Should the law be clarified with respect to whether the scanning of works held in libraries for the purpose of making their content searchable on the Internet goes beyond the scope of current exceptions to copyright?\nYes.\nNot all the material digitised by publishers is scanned with OCR (Optical Character Recognition) with the purpose of making the resulting content searchable. If the rights holders will not do this, libraries should be able to offer this service. It would have a transformative effect on research, learning and teaching by opening up a mass of content to users which can be searched using search engines. The interests of copyright holders will not be harmed, because the resulting output will act as marketing material for their materials.', 'https://circabc.europa.eu/sd/d/84235a12-f544-48e4-9a95-7b75565337aa/liber_ligue_des_bibliothtques_europuennes_de_recherche.pdf.', NULL, NULL, NULL, NULL),
	(9, 9, 1, 'Gentlemen prefer blondes', 'The handsome and dashing professor of evolutionary  psychology, and arbiter of male taste,  Kenny Clump, today stated that gentlemen prefer blondes because it fair hair reminds them of the sunny savannah.  It is great to have this preference confirmed because Iâ€™m tired of hearing people dispute it. For example, that old fool Joachim Jolster, the editor of What Men Want who wrote that Jane Russell outshone Marilyn, conclusively proving that men prefer brunettes. And I have no time for detractors who say Kenny works for a peroxide company.', '', NULL, NULL, NULL, NULL),
	(10, 10, 1, 'UK government\'s spending cuts strategy', 'Given that the size of the public debt is very high and this is threatening UKâ€™s credit rating, the only fair and responsible course of action is for the government to cut public spending by 20% in order to overcome the current recession and put the economy back on track. Unless this is done, the UK economy will not recover and unemployment will rise.', '', NULL, NULL, NULL, NULL),
	(11, 11, 1, 'austerity', 'Given that the size of the public debt is very high and this is threatening UKâ€™s credit rating, the only fair and responsible course of action is for the government to cut public spending by 20% in order to overcome the current recession and put the economy back on track. Unless this is done, the UK economy will not recover and unemployment will rise.', '', NULL, NULL, NULL, NULL),
	(12, 12, 1, 'austerity', 'Given that the size of the public debt is very high and this is threatening UKâ€™s credit rating, the only fair and responsible course of action is for the government to cut public spending by 20% in order to overcome the current recession and put the economy back on track. Unless this is done, the UK economy will not recover and unemployment will rise.', '', NULL, NULL, NULL, NULL);
/*!40000 ALTER TABLE `ART_documents` ENABLE KEYS */;


-- Dumping structure for table impact_UoL_UvA_DB_v1_5.ART_relations_discussions
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.ART_relations_discussions: ~13 rows (approximately)
DELETE FROM `ART_relations_discussions`;
...
INSERT INTO `ART_relations_discussions` (`id`, `relation_id`, `relation_sort`, `discussion`) VALUES
	...
	(12, 2, 'practical_reasoning_as', 36),
	(13, 19, 'credible_source_as', 28),
	(14, 3, 'practical_reasoning_as', 33);
/*!40000 ALTER TABLE `ART_relations_discussions` ENABLE KEYS */;


-- Dumping structure for table impact_UoL_UvA_DB_v1_5.ART_text_sections
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.ART_text_sections: ~25 rows (approximately)
DELETE FROM `ART_text_sections`;
...
INSERT INTO `ART_text_sections` (`id`, `document_id`, `text`, `start_offset`, `end_offset`, `timestamp_added`, `added_by`, `timestamp_removed`, `removed_by`) VALUES
	(1, NULL, 'government', NULL, NULL, NULL, NULL, NULL, NULL),
	(2, 4, 'clarification of the law', 23, 39, NULL, NULL, NULL, NULL),
	(3, 4, 'Not all the material digitised by publishers is scanned', 234, 330, NULL, NULL, NULL, NULL),
	(4, 4, 'transformative effect on research', 496, 529, NULL, NULL, NULL, NULL),
	(5, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL),
	(6, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL),
	(7, NULL, 'male taste', NULL, NULL, NULL, NULL, NULL, NULL),
	(8, 4, 'Kenny Clump', 92, 103, NULL, NULL, NULL, NULL),
	(9, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL),
	(10, 4, 'gentlemen prefer blondes because it fair hair reminds them of the sunny savannah', 123, 203, NULL, NULL, NULL, NULL),
	(11, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL),
	(12, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL),
	(13, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL),
	(14, NULL, 'the government', NULL, NULL, NULL, NULL, NULL, NULL),
	(15, NULL, 'The government ought to cut public spending by 20% ', NULL, NULL, NULL, NULL, NULL, NULL),
	(16, NULL, 'The size of the public debt is very high.', NULL, NULL, NULL, NULL, NULL, NULL),
	(17, NULL, 'The size of the public debt is threatening UKâ€™s credit rating.', NULL, NULL, NULL, NULL, NULL, NULL),
	(18, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL),
	(19, NULL, 'If the government cuts public spending, the current recession will be overcome and the economy will be back on track.', NULL, NULL, NULL, NULL, NULL, NULL),
	(20, NULL, 'Cutting public spending is the only fair and responsible action.', NULL, NULL, NULL, NULL, NULL, NULL),
	(21, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL),
	(22, NULL, 'online research', NULL, NULL, NULL, NULL, NULL, NULL),
	(23, NULL, 'Some material held by publishers is not scanned, so it cannot be searched for', NULL, NULL, NULL, NULL, NULL, NULL),
	(24, NULL, 'LIBER', NULL, NULL, NULL, NULL, NULL, NULL),
	(25, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL);
/*!40000 ALTER TABLE `ART_text_sections` ENABLE KEYS */;


-- Dumping structure for table impact_UoL_UvA_DB_v1_5.ART_text_section_combinations
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.ART_text_section_combinations: ~28 rows (approximately)
DELETE FROM `ART_text_section_combinations`;
...
-- Dumping structure for table impact_UoL_UvA_DB_v1_5.concl
DROP TABLE IF EXISTS `concl`;
CREATE TABLE IF NOT EXISTS `concl` (
  `concl_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `concl_name` text,
  `datetime` datetime DEFAULT NULL,
  `user` int(11) DEFAULT NULL,
  `relation_id` bigint(20) DEFAULT NULL,
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.concl: ~0 rows (approximately)
DELETE FROM `concl`;
/*!40000 ALTER TABLE `concl` DISABLE KEYS */;
/*!40000 ALTER TABLE `concl` ENABLE KEYS */;


-- Dumping structure for table impact_UoL_UvA_DB_v1_5.conjunction
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.conjunction: ~13 rows (approximately)
...
INSERT INTO `conjunction` (`conjunction_id`, `conjunction_name`, `datetime`, `user`, `relation_id`, `mutation_sort`, `tsc_id`) VALUES
	...
	(9, NULL, NULL, NULL, NULL, 'create', NULL),
	(10, NULL, NULL, NULL, NULL, 'create', NULL),
	(11, NULL, NULL, NULL, NULL, 'create', NULL),
	(12, NULL, NULL, NULL, NULL, 'create', NULL),
	(13, NULL, NULL, NULL, NULL, 'create', NULL);
/*!40000 ALTER TABLE `conjunction` ENABLE KEYS */;


-- Dumping structure for table impact_UoL_UvA_DB_v1_5.consultation
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.consultation: ~1 rows (approximately)
DELETE FROM `consultation`;
/*!40000 ALTER TABLE `consultation` DISABLE KEYS */;
INSERT INTO `consultation` (`consultation_id`, `practical_reasoning_as`, `credible_source_as`, `value_credible_source_as`, `value_recognition_as`, `consultation_info`) VALUES
	(4, 1, 5, 7, 6, 'Consultation LIBER');
/*!40000 ALTER TABLE `consultation` ENABLE KEYS */;


-- Dumping structure for table impact_UoL_UvA_DB_v1_5.consultation_inst
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.consultation_inst: ~19 rows (approximately)
DELETE FROM `consultation_inst`;
...
-- Dumping structure for table impact_UoL_UvA_DB_v1_5.credible_source_as
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.credible_source_as: ~10 rows (approximately)
DELETE FROM `credible_source_as`;
...
INSERT INTO `credible_source_as` (`credible_source_as_id`, `domain_source`, `source_proposition`, `domain_proposition`, `datetime`, `user`, `relation_id`, `mutation_sort`, `tsc_id`) VALUES
	...
	(19, 19, 19, 19, '2013-01-14 15:01:51', NULL, NULL, 'create', 16);
/*!40000 ALTER TABLE `credible_source_as` ENABLE KEYS */;


-- Dumping structure for table impact_UoL_UvA_DB_v1_5.credible_source_occurrence
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.credible_source_occurrence: ~6 rows (approximately)
DELETE FROM `credible_source_occurrence`;
...
-- Dumping structure for table impact_UoL_UvA_DB_v1_5.credible_source_ur
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.credible_source_ur: ~114 rows (approximately)
DELETE FROM `credible_source_ur`;
...
INSERT INTO `credible_source_ur` (`credible_source_ur_id`, `credible_source_as`, `consultation_inst`, `domain_source_resp`, `domain_prop_resp`, `source_prop_resp`) VALUES
	...
	(103, 10, 18, 'agree', 'agree', 'agree'),
	(104, 11, 18, 'agree', 'agree', 'agree'),
	(105, 12, 18, 'agree', 'agree', 'agree'),
	(106, 13, 18, 'agree', 'agree', 'agree'),
	(107, 14, 18, 'agree', 'agree', 'agree'),
	(108, 15, 18, 'agree', 'agree', 'agree'),
	(109, 10, 19, 'agree', 'agree', 'agree'),
	(110, 11, 19, 'agree', 'agree', 'agree'),
	(111, 12, 19, 'agree', 'agree', 'agree'),
	(112, 13, 19, 'agree', 'disagree', 'agree'),
	(113, 14, 19, 'agree', 'agree', 'agree'),
	(114, 15, 19, 'agree', 'agree', 'agree');
/*!40000 ALTER TABLE `credible_source_ur` ENABLE KEYS */;


-- Dumping structure for table impact_UoL_UvA_DB_v1_5.domain
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.domain: ~4 rows (approximately)
DELETE FROM `domain`;
/*!40000 ALTER TABLE `domain` DISABLE KEYS */;
INSERT INTO `domain` (`domain_id`, `datetime`, `user`, `relation_id`, `mutation_sort`, `tsc_id`, `domain_name`) VALUES
	(1, '0000-00-00 00:00:00', NULL, 0, 'create', 25, 'online research'),
	...
	(4, '2013-01-14 15:01:50', NULL, NULL, 'create', 10, 'male taste');
/*!40000 ALTER TABLE `domain` ENABLE KEYS */;


-- Dumping structure for table impact_UoL_UvA_DB_v1_5.domain_proposition
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.domain_proposition: ~19 rows (approximately)
DELETE FROM `domain_proposition`;
...
INSERT INTO `domain_proposition` (`domain_proposition_id`, `domain`, `proposition`, `datetime`, `user`, `relation_id`, `mutation_sort`, `tsc_id`) VALUES
	...
	(19, 4, 12, '2013-01-14 15:01:51', NULL, NULL, 'create', 14);
/*!40000 ALTER TABLE `domain_proposition` ENABLE KEYS */;


-- Dumping structure for table impact_UoL_UvA_DB_v1_5.domain_source
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.domain_source: ~10 rows (approximately)
DELETE FROM `domain_source`;
...
INSERT INTO `domain_source` (`domain_source_id`, `domain`, `source`, `datetime`, `user`, `relation_id`, `mutation_sort`, `tsc_id`) VALUES
	...
	(19, 4, 6, '2013-01-14 15:01:50', NULL, NULL, 'create', 12);
/*!40000 ALTER TABLE `domain_source` ENABLE KEYS */;


-- Dumping structure for table impact_UoL_UvA_DB_v1_5.external_info
...
CREATE TABLE IF NOT EXISTS `general_as` (
  ...
  CONSTRAINT `general_as_ibfk_2` FOREIGN KEY (`concl`) REFERENCES `concl` (`concl_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table impact_UoL_UvA_DB_v1_5.general_as: ~0 rows (approximately)
DELETE FROM `general_as`;
/*!40000 ALTER TABLE `general_as` DISABLE KEYS */;
/*!40000 ALTER TABLE `general_as` ENABLE KEYS */;


-- Dumping structure for table impact_UoL_UvA_DB_v1_5.practical_reasoning_as
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.practical_reasoning_as: ~3 rows (approximately)
DELETE FROM `practical_reasoning_as`;
...
INSERT INTO `practical_reasoning_as` (`practical_reasoning_as_id`, `circumstances`, `action`, `consequences`, `values`, `datetime`, `user`, `relation_id`, `mutation_sort`, `tsc_id`) VALUES
	...
	(2, 8, 3, 9, 10, '2012-12-17 10:19:26', NULL, NULL, 'create', 9),
	(3, 11, 4, 12, 13, '2013-01-18 19:18:24', NULL, NULL, 'create', 24);
/*!40000 ALTER TABLE `practical_reasoning_as` ENABLE KEYS */;


-- Dumping structure for table impact_UoL_UvA_DB_v1_5.premise
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.premise: ~0 rows (approximately)
DELETE FROM `premise`;
/*!40000 ALTER TABLE `premise` DISABLE KEYS */;
/*!40000 ALTER TABLE `premise` ENABLE KEYS */;


-- Dumping structure for table impact_UoL_UvA_DB_v1_5.premise_occurrence
DROP TABLE IF EXISTS `premise_occurrence`;
CREATE TABLE IF NOT EXISTS `premise_occurrence` (
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.premise_occurrence: ~0 rows (approximately)
DELETE FROM `premise_occurrence`;
/*!40000 ALTER TABLE `premise_occurrence` DISABLE KEYS */;
/*!40000 ALTER TABLE `premise_occurrence` ENABLE KEYS */;


-- Dumping structure for table impact_UoL_UvA_DB_v1_5.proposition
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.proposition: ~16 rows (approximately)
...
INSERT INTO `proposition` (`proposition_id`, `proposition_string`, `datetime`, `user`, `relation_id`, `mutation_sort`, `tsc_id`) VALUES
	(1, 'Some material held by publishers is not scanned, so it cannot be searched for', '0000-00-00 00:00:00', NULL, 0, 'create', 26),
	...
	(10, 'Not all the material digitised by publishers is scanned', '2012-12-17 10:19:25', NULL, NULL, 'create', 6),
	(11, 'transformative effect on research', '2012-12-17 10:19:25', NULL, NULL, 'create', 7),
	(12, 'gentlemen prefer blondes because it fair hair reminds them of the sunny savannah', '2013-01-14 15:01:50', NULL, NULL, 'create', 13),
	(13, 'The size of the public debt is very high.', '2013-01-18 19:18:23', NULL, NULL, 'create', 19),
	(14, 'The size of the public debt is threatening UKâ€™s credit rating.', '2013-01-18 19:18:23', NULL, NULL, 'create', 20),
	(15, '', '2013-01-18 19:18:23', NULL, NULL, 'create', 21),
	(16, 'If the government cuts public spending, the current recession will be overcome and the economy will be back on track.', '2013-01-18 19:18:24', NULL, NULL, 'create', 22);
/*!40000 ALTER TABLE `proposition` ENABLE KEYS */;


-- Dumping structure for table impact_UoL_UvA_DB_v1_5.proposition_prur
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.proposition_prur: ~114 rows (approximately)
DELETE FROM `proposition_prur`;
...
-- Dumping structure for table impact_UoL_UvA_DB_v1_5.prop_occurrence
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.prop_occurrence: ~12 rows (approximately)
DELETE FROM `prop_occurrence`;
...
INSERT INTO `prop_occurrence` (`prop_occurrence_id`, `proposition`, `conjunction`, `datetime`, `user`, `relation_id`, `mutation_sort`, `tsc_id`) VALUES
	...
	(7, 10, 8, NULL, NULL, NULL, 'create', NULL),
	(8, 11, 9, NULL, NULL, NULL, 'create', NULL),
	(9, 13, 11, NULL, NULL, NULL, 'create', NULL),
	(10, 14, 11, NULL, NULL, NULL, 'create', NULL),
	(11, 15, 11, NULL, NULL, NULL, 'create', NULL),
	(12, 16, 12, NULL, NULL, NULL, 'create', NULL);
/*!40000 ALTER TABLE `prop_occurrence` ENABLE KEYS */;


-- Dumping structure for table impact_UoL_UvA_DB_v1_5.source
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.source: ~2 rows (approximately)
DELETE FROM `source`;
/*!40000 ALTER TABLE `source` DISABLE KEYS */;
INSERT INTO `source` (`source_id`, `source_name`, `datetime`, `user`, `relation_id`, `mutation_sort`, `tsc_id`) VALUES
	(5, 'LIBER', '0000-00-00 00:00:00', NULL, 0, 'create', 27),
	(6, 'Kenny Clump', '2013-01-14 15:01:50', NULL, NULL, 'create', 11);
/*!40000 ALTER TABLE `source` ENABLE KEYS */;


-- Dumping structure for table impact_UoL_UvA_DB_v1_5.source_proposition
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.source_proposition: ~10 rows (approximately)
DELETE FROM `source_proposition`;
...
INSERT INTO `source_proposition` (`source_proposition_id`, `proposition`, `source`, `datetime`, `user`, `relation_id`, `mutation_sort`, `tsc_id`) VALUES
	...
	(19, 12, 6, '2013-01-14 15:01:51', NULL, NULL, 'create', 15);
/*!40000 ALTER TABLE `source_proposition` ENABLE KEYS */;


-- Dumping structure for table impact_UoL_UvA_DB_v1_5.user
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.user: ~19 rows (approximately)
DELETE FROM `user`;
...
-- Dumping structure for table impact_UoL_UvA_DB_v1_5.value
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.value: ~5 rows (approximately)
DELETE FROM `value`;
/*!40000 ALTER TABLE `value` DISABLE KEYS */;
INSERT INTO `value` (`value_id`, `value_name`, `datetime`, `user`, `relation_id`, `mutation_sort`, `tsc_id`) VALUES
	...
	(4, '', '2012-12-17 10:19:26', NULL, NULL, 'create', 8),
	(5, 'Cutting public spending is the only fair and responsible action.', '2013-01-18 19:18:24', NULL, NULL, 'create', 23);
/*!40000 ALTER TABLE `value` ENABLE KEYS */;


-- Dumping structure for table impact_UoL_UvA_DB_v1_5.value_credible_source_as
DROP TABLE IF EXISTS `value_credible_source_as`;
CREATE TABLE IF NOT EXISTS `value_credible_source_as` (
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.value_credible_source_as: ~3 rows (approximately)
DELETE FROM `value_credible_source_as`;
/*!40000 ALTER TABLE `value_credible_source_as` DISABLE KEYS */;
INSERT INTO `value_credible_source_as` (`value_credible_source_as_id`, `domain_source`, `action`, `value_occurrence_default_choice`, `datetime`, `user`, `relation_id`, `mutation_sort`, `tsc_id`) VALUES
...
-- Dumping structure for table impact_UoL_UvA_DB_v1_5.value_credible_source_occurrence
DROP TABLE IF EXISTS `value_credible_source_occurrence`;
CREATE TABLE IF NOT EXISTS `value_credible_source_occurrence` (
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.value_credible_source_occurrence: ~3 rows (approximately)
DELETE FROM `value_credible_source_occurrence`;
/*!40000 ALTER TABLE `value_credible_source_occurrence` DISABLE KEYS */;
INSERT INTO `value_credible_source_occurrence` (`value_credible_source_occurrence_id`, `conjunction`, `value_credible_source_as`) VALUES
	(1, 7, 1),
	(2, 7, 2),
	(3, 7, 3);
...
-- Dumping structure for table impact_UoL_UvA_DB_v1_5.value_credible_source_ur
DROP TABLE IF EXISTS `value_credible_source_ur`;
CREATE TABLE IF NOT EXISTS `value_credible_source_ur` (
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.value_credible_source_ur: ~57 rows (approximately)
DELETE FROM `value_credible_source_ur`;
/*!40000 ALTER TABLE `value_credible_source_ur` DISABLE KEYS */;
INSERT INTO `value_credible_source_ur` (`value_credible_source_ur_id`, `value_credible_source_as`, `consultation_inst`, `domain_source_resp`, `domain_action_value_resp`, `source_action_value_resp`) VALUES
	...
	(52, 3, 18, 'agree', 'agree', 'agree'),
	(53, 2, 18, 'agree', 'agree', 'agree'),
	(54, 1, 18, 'agree', 'agree', 'agree'),
	(55, 3, 19, 'agree', 'disagree', 'disagree'),
	(56, 2, 19, 'agree', 'agree', 'agree'),
	(57, 1, 19, 'agree', 'agree', 'agree');
/*!40000 ALTER TABLE `value_credible_source_ur` ENABLE KEYS */;


-- Dumping structure for table impact_UoL_UvA_DB_v1_5.value_occurrence
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.value_occurrence: ~5 rows (approximately)
DELETE FROM `value_occurrence`;
...
INSERT INTO `value_occurrence` (`value_occurrence_id`, `value`, `conjunction`, `datetime`, `user`, `relation_id`, `mutation_sort`, `tsc_id`) VALUES
	...
	(3, 1, 3, '0000-00-00 00:00:00', NULL, 0, 'create', NULL),
	(4, 4, 10, NULL, NULL, NULL, 'create', NULL),
	(5, 5, 13, NULL, NULL, NULL, 'create', NULL);
/*!40000 ALTER TABLE `value_occurrence` ENABLE KEYS */;


-- Dumping structure for table impact_UoL_UvA_DB_v1_5.value_occurrence_default_choice
DROP TABLE IF EXISTS `value_occurrence_default_choice`;
CREATE TABLE IF NOT EXISTS `value_occurrence_default_choice` (
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.value_occurrence_default_choice: ~3 rows (approximately)
DELETE FROM `value_occurrence_default_choice`;
/*!40000 ALTER TABLE `value_occurrence_default_choice` DISABLE KEYS */;
INSERT INTO `value_occurrence_default_choice` (`value_occurrence_default_choice_id`, `value_occurrence`, `default_choice`) VALUES
	(1, 1, 'demote'),
	(2, 2, 'neutral'),
	(3, 3, 'promote');
...
-- Dumping structure for table impact_UoL_UvA_DB_v1_5.value_prur
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.value_prur: ~57 rows (approximately)
DELETE FROM `value_prur`;
...
-- Dumping structure for table impact_UoL_UvA_DB_v1_5.value_recognition_as
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.value_recognition_as: ~3 rows (approximately)
DELETE FROM `value_recognition_as`;
...
-- Dumping structure for table impact_UoL_UvA_DB_v1_5.value_recognition_occurrence
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.value_recognition_occurrence: ~3 rows (approximately)
DELETE FROM `value_recognition_occurrence`;
...
-- Dumping structure for table impact_UoL_UvA_DB_v1_5.value_vrur
...
-- Dumping data for table impact_UoL_UvA_DB_v1_5.value_vrur: ~57 rows (approximately)
DELETE FROM `value_vrur`;
...
INSERT INTO `value_vrur` (`value_vrur_id`, `value_recognition_as`, `consultation_inst`, `value`, `value_recog_resp`, `source_endow_resp`) VALUES
	...
	(52, 6, 18, 3, 'agree', 'agree'),
	(53, 5, 18, 2, 'agree', 'agree'),
	(54, 4, 18, 1, 'agree', 'agree'),
	(55, 6, 19, 3, 'agree', 'agree'),
	(56, 5, 19, 2, 'agree', 'agree'),
	(57, 4, 19, 1, 'agree', 'agree');
