...
class TextSection extends DbItem{
   ...
   * stored document id and start and end offsets (if any). Also sets the URL 
   * of the document, if available  If necessary values are incomplete, nothing 
   * is done and the function returns false. If the quote could be set, returns 
   * true.
   * @since 15 October 2012
   **/
  function setQuote(){
