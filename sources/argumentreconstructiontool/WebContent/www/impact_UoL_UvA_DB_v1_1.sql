...
--
-- Database: `impact_UoL_UvA_DB_v1_1`
--
...
INSERT INTO `consultation` VALUES(1, 1, 4, 'Library interests');
INSERT INTO `consultation` VALUES(2, 1, 4, 'Industry interests');
INSERT INTO `consultation` VALUES(3, 1, 4, 'Government interests');
...
--
-- Gegevens worden uitgevoerd voor tabel `consultation_inst`
--
...
INSERT INTO `consult_value` VALUES(1, 7, 1);
INSERT INTO `consult_value` VALUES(2, 8, 2);
INSERT INTO `consult_value` VALUES(3, 9, 3);
...
--
-- Gegevens worden uitgevoerd voor tabel `credible_source_ur`
--
...
--
-- Gegevens worden uitgevoerd voor tabel `external_info`
--
...
--
-- Gegevens worden uitgevoerd voor tabel `proposition_prur`
--
...
--
-- Gegevens worden uitgevoerd voor tabel `value_prur`
--
...
--
-- Gegevens worden uitgevoerd voor tabel `value_vrur`
--

-- *********************************************
-- ******** TABLES FOR BOTH SCT AND ART ********
-- *********************************************
...
INSERT INTO `action` VALUES(1, 'clarify the law and exceptions to allow libraries to scan material.', 1, '0000-00-00 00:00:00', NULL, 0, 'create', NULL);
...
INSERT INTO `ART_discussions` VALUES(19, 1, 'Neighborhood centre discussion', 'This is a demo!!!', NULL, NULL, NULL, NULL);
INSERT INTO `ART_discussions` VALUES(23, NULL, 'Male taste for women', 'This discussion is about all relevant aspects of male taste for women.', NULL, NULL, NULL, NULL);
INSERT INTO `ART_discussions` VALUES(27, NULL, 'Copyright in the knowledge economy', 'introduction', NULL, NULL, NULL, NULL);
...
INSERT INTO `ART_relations_discussions` VALUES(2, 1, 'credible_source_as', 19);
INSERT INTO `ART_relations_discussions` VALUES(3, 2, 'credible_source_as', 19);
INSERT INTO `ART_relations_discussions` VALUES(4, 3, 'credible_source_as', 19);
INSERT INTO `ART_relations_discussions` VALUES(5, 4, 'credible_source_as', 19);
INSERT INTO `ART_relations_discussions` VALUES(6, 5, 'credible_source_as', 19);
INSERT INTO `ART_relations_discussions` VALUES(7, 6, 'credible_source_as', 19);
INSERT INTO `ART_relations_discussions` VALUES(8, 7, 'credible_source_as', 19);
INSERT INTO `ART_relations_discussions` VALUES(9, 8, 'credible_source_as', 19);
INSERT INTO `ART_relations_discussions` VALUES(10, 9, 'credible_source_as', 19);
INSERT INTO `ART_relations_discussions` VALUES(11, 1, 'practical_reasoning_as', 19);
...
INSERT INTO `ART_text_sections` VALUES(3, 2, 'Text section 3 (doc 2)', 0, 0, NULL, NULL, NULL, NULL);
INSERT INTO `ART_text_sections` VALUES(4, NULL, 'De bron van het alles', 0, 0, NULL, NULL, NULL, NULL);
INSERT INTO `ART_text_sections` VALUES(5, NULL, 'propositieee', 0, 0, NULL, NULL, NULL, NULL);
INSERT INTO `ART_text_sections` VALUES(6, 32, 'Something useful', 155, 200, NULL, NULL, NULL, NULL);
...
INSERT INTO `value` VALUES(1, 'Legal clarity', 'demote', '0000-00-00 00:00:00', NULL, 0, 'create', NULL);
INSERT INTO `value` VALUES(2, 'Publisher profits', 'neutral', '0000-00-00 00:00:00', NULL, 0, 'create', NULL);
INSERT INTO `value` VALUES(3, 'Research, learning, and teaching', 'promote', '0000-00-00 00:00:00', NULL, 0, 'create', NULL);
...
--
ALTER TABLE `action`
  ADD CONSTRAINT `action_ibfk_1` FOREIGN KEY (`agent`) REFERENCES `agent` (`agent_id`);

--
-- Beperkingen voor tabel `consultation`
--
ALTER TABLE `consultation`
  ADD CONSTRAINT `consultation_ibfk_1` FOREIGN KEY (`practical_reasoning_as`) REFERENCES `practical_reasoning_as` (`practical_reasoning_as_id`),
  ADD CONSTRAINT `consultation_ibfk_2` FOREIGN KEY (`credible_source_as`) REFERENCES `conjunction` (`conjunction_id`);

--
-- Beperkingen voor tabel `consultation_inst`
--
ALTER TABLE `consultation_inst`
  ADD CONSTRAINT `consultation_inst_ibfk_1` FOREIGN KEY (`user`) REFERENCES `user` (`user_id`),
  ADD CONSTRAINT `consultation_inst_ibfk_2` FOREIGN KEY (`consultation`) REFERENCES `consultation` (`consultation_id`);

--
-- Beperkingen voor tabel `consult_proposition`
--
ALTER TABLE `consult_proposition`
  ADD CONSTRAINT `consult_proposition_ibfk_1` FOREIGN KEY (`credible_source_as`) REFERENCES `credible_source_as` (`credible_source_as_id`),
  ADD CONSTRAINT `consult_proposition_ibfk_2` FOREIGN KEY (`proposition`) REFERENCES `proposition` (`proposition_id`);

--
-- Beperkingen voor tabel `consult_value`
--
ALTER TABLE `consult_value`
  ADD CONSTRAINT `consult_value_ibfk_1` FOREIGN KEY (`credible_source_as`) REFERENCES `credible_source_as` (`credible_source_as_id`),
  ADD CONSTRAINT `consult_value_ibfk_2` FOREIGN KEY (`value`) REFERENCES `value` (`value_id`);

--
-- Beperkingen voor tabel `credible_source_as`
--
ALTER TABLE `credible_source_as`
  ADD CONSTRAINT `credible_source_as_ibfk_1` FOREIGN KEY (`domain_proposition`) REFERENCES `domain_proposition` (`domain_proposition_id`),
  ADD CONSTRAINT `credible_source_as_ibfk_2` FOREIGN KEY (`source_proposition`) REFERENCES `source_proposition` (`source_proposition_id`),
  ADD CONSTRAINT `credible_source_as_ibfk_3` FOREIGN KEY (`domain_source`) REFERENCES `domain_source` (`domain_source_id`);

--
-- Beperkingen voor tabel `credible_source_occurrence`
--
ALTER TABLE `credible_source_occurrence`
  ADD CONSTRAINT `credible_source_occurrence_ibfk_1` FOREIGN KEY (`credible_source_as`) REFERENCES `credible_source_as` (`credible_source_as_id`),
  ADD CONSTRAINT `credible_source_occurrence_ibfk_2` FOREIGN KEY (`conjunction`) REFERENCES `conjunction` (`conjunction_id`);

--
-- Beperkingen voor tabel `credible_source_ur`
--
ALTER TABLE `credible_source_ur`
  ADD CONSTRAINT `credible_source_ur_ibfk_1` FOREIGN KEY (`consultation_inst`) REFERENCES `consultation_inst` (`consultation_inst_id`),
  ADD CONSTRAINT `credible_source_ur_ibfk_2` FOREIGN KEY (`credible_source_as`) REFERENCES `credible_source_as` (`credible_source_as_id`);

--
-- Beperkingen voor tabel `domain_proposition`
--
ALTER TABLE `domain_proposition`
  ADD CONSTRAINT `domain_proposition_ibfk_1` FOREIGN KEY (`proposition`) REFERENCES `proposition` (`proposition_id`),
  ADD CONSTRAINT `domain_proposition_ibfk_2` FOREIGN KEY (`domain`) REFERENCES `domain` (`domain_id`);

--
-- Beperkingen voor tabel `domain_source`
--
ALTER TABLE `domain_source`
  ADD CONSTRAINT `domain_source_ibfk_1` FOREIGN KEY (`source`) REFERENCES `source` (`source_id`),
  ADD CONSTRAINT `domain_source_ibfk_2` FOREIGN KEY (`domain`) REFERENCES `domain` (`domain_id`);

--
-- Beperkingen voor tabel `external_info`
--
ALTER TABLE `external_info`
  ADD CONSTRAINT `external_info_ibfk_1` FOREIGN KEY (`consultation_inst`) REFERENCES `consultation_inst` (`consultation_inst_id`);

--
-- Beperkingen voor tabel `practical_reasoning_as`
--
ALTER TABLE `practical_reasoning_as`
  ADD CONSTRAINT `practical_reasoning_as_ibfk_1` FOREIGN KEY (`values`) REFERENCES `conjunction` (`conjunction_id`),
  ADD CONSTRAINT `practical_reasoning_as_ibfk_2` FOREIGN KEY (`circumstances`) REFERENCES `conjunction` (`conjunction_id`),
  ADD CONSTRAINT `practical_reasoning_as_ibfk_3` FOREIGN KEY (`action`) REFERENCES `action` (`action_id`),
  ADD CONSTRAINT `practical_reasoning_as_ibfk_4` FOREIGN KEY (`consequences`) REFERENCES `conjunction` (`conjunction_id`);

--
-- Beperkingen voor tabel `proposition_prur`
--
ALTER TABLE `proposition_prur`
  ADD CONSTRAINT `proposition_prur_ibfk_1` FOREIGN KEY (`proposition`) REFERENCES `proposition` (`proposition_id`),
  ADD CONSTRAINT `proposition_prur_ibfk_2` FOREIGN KEY (`consultation_inst`) REFERENCES `consultation_inst` (`consultation_inst_id`),
  ADD CONSTRAINT `proposition_prur_ibfk_3` FOREIGN KEY (`practical_reasoning_as`) REFERENCES `practical_reasoning_as` (`practical_reasoning_as_id`);

--
-- Beperkingen voor tabel `prop_occurrence`
--
ALTER TABLE `prop_occurrence`
  ADD CONSTRAINT `prop_occurrence_ibfk_1` FOREIGN KEY (`conjunction`) REFERENCES `conjunction` (`conjunction_id`),
  ADD CONSTRAINT `prop_occurrence_ibfk_2` FOREIGN KEY (`proposition`) REFERENCES `proposition` (`proposition_id`);

--
-- Beperkingen voor tabel `source_proposition`
--
ALTER TABLE `source_proposition`
  ADD CONSTRAINT `source_proposition_ibfk_1` FOREIGN KEY (`proposition`) REFERENCES `proposition` (`proposition_id`),
  ADD CONSTRAINT `source_proposition_ibfk_2` FOREIGN KEY (`source`) REFERENCES `source` (`source_id`);

--
-- Beperkingen voor tabel `value_occurrence`
--
ALTER TABLE `value_occurrence`
  ADD CONSTRAINT `value_occurrence_ibfk_1` FOREIGN KEY (`conjunction`) REFERENCES `conjunction` (`conjunction_id`),
  ADD CONSTRAINT `value_occurrence_ibfk_2` FOREIGN KEY (`value`) REFERENCES `value` (`value_id`);

--
-- Beperkingen voor tabel `value_prur`
--
ALTER TABLE `value_prur`
  ADD CONSTRAINT `value_prur_ibfk_1` FOREIGN KEY (`consultation_inst`) REFERENCES `consultation_inst` (`consultation_inst_id`),
  ADD CONSTRAINT `value_prur_ibfk_2` FOREIGN KEY (`value`) REFERENCES `value` (`value_id`),
  ADD CONSTRAINT `value_prur_ibfk_3` FOREIGN KEY (`practical_reasoning_as`) REFERENCES `practical_reasoning_as` (`practical_reasoning_as_id`);

--
-- Beperkingen voor tabel `value_recognition_as`
--
ALTER TABLE `value_recognition_as`
  ADD CONSTRAINT `value_recognition_as_ibfk_1` FOREIGN KEY (`value`) REFERENCES `value` (`value_id`),
  ADD CONSTRAINT `value_recognition_as_ibfk_2` FOREIGN KEY (`source`) REFERENCES `source` (`source_id`);

--
-- Beperkingen voor tabel `value_vrur`
--
ALTER TABLE `value_vrur`
  ADD CONSTRAINT `value_vrur_ibfk_1` FOREIGN KEY (`consultation_inst`) REFERENCES `consultation_inst` (`consultation_inst_id`),
  ADD CONSTRAINT `value_vrur_ibfk_2` FOREIGN KEY (`value`) REFERENCES `value` (`value_id`),
  ADD CONSTRAINT `value_vrur_ibfk_3` FOREIGN KEY (`value_recognition_as`) REFERENCES `value_recognition_as` (`value_recognition_as_id`);
