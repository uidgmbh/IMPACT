...
class Auth_OpenID_ServiceEndpoint {
    ...
    {
        // NASTY HACK to prevent "No matching endpoint found after discovering ..." message
        // sometimes appearing (awaiting fix, see: http://trac.openidenabled.com/trac/ticket/95)
