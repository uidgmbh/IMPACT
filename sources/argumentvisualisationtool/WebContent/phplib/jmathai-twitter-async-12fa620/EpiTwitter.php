...
class EpiTwitter extends EpiOAuth
{
  ...
  private function request($method, $endpoint, $params = null)
  {
    ...
    $resp= call_user_func(array($this, 'httpRequest'), $method, $url, $params, $this->isMultipart($params));

	// This was never coming back - maye because I am requesting xml as the response
